...
const StudentSignup = () => {
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4000/student/signup', { name, email, password });
      ...
      <div className="container login-container">
        ...
        <form onSubmit={handleSignup} className="form-signin">
          ...
          <p className="text-center mt-3">
            Already have an account? <Link to="/login/student" className="toggle-button">Login</Link>
          </p>
        </form>
      </div>
      <Footer />
